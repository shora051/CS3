...
class Main {
	public static void main(String[] args) {
		try {
			GameTreeTest gm = new GameTreeTest();
			gm.setUp();
...
//		test01_rootNodeAtStart();
//		test02_foundAnswerAtStart();
//		test03_makeFirstYesChoice();
//		test04_checkFoundAnswerAgain();
//		test05_makeNoChoice();
//		test06_foundAnAnswerNode();
...
//		assertFalse("Found answer should be false", aGame.foundAnswer());
		System.out.println(aGame.foundAnswer());
	}
//
////	@Test
